      ...
      <div className="container mx-auto px-8 lg:flex">
        <div className="text-center lg:text-left lg:w-1/2">
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
            Hire The Best Writing Talents On Demand
          </h1>
          <p className="text-xl lg:text-2xl mt-6 font-light">
Scale your content cretion with Strategically's exclusive writer network. Rigorously screened and managed for your most important projects.
              </p>
          <p className="mt-8 md:mt-12">
          <a href="https://strategically.outgrow.us/strategically-2">
            <Button size="lg">HIRE A WRITER</Button></a>
          </p>
        </div>
      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row md:-mx-3">
          {writerData.map(writer => (
            <div key={writer.writerName} className="flex-1 px-3">
